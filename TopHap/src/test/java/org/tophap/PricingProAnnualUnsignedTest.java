...
public class PricingProAnnualUnsignedTest extends SingleTest {
    ...
    void pricingProAnnualUnsigned() throws InterruptedException {
        ...
        final By proPlanButtonLocator = By.xpath("//div[@class='th-plan-info th-recommended']//button");
...
//        }
        ...
        getDriver().findElement(proPlanButtonLocator).click();
        //Sign in with pre-registered user
        TestHelper.loginFromSignupPage(getDriver(), UserHelper.EMAIL, UserHelper.PASSWORD);
        UserHelper.emailConfirmationFailureMsgClose(getDriver());
        wait.until(ExpectedConditions.elementToBeClickable(getDriver().findElement(proPlanButtonLocator)));
...
//        }
        ...
        TestHelper.enterCreditCardData(getDriver(), TestHelper.CREDIT_CARD, TestHelper.CREDIT_CARD_EXPIRATION,
                TestHelper.CREDIT_CARD_CVV, TestHelper.POSTAL_CODE);
        ...
        getDriver().findElement(By.xpath("//button[@class='MuiButtonBase-root th-button th-action-button " +
                "th-cancel-button']")).click();
        //wait.until(ExpectedConditions.invisibilityOf(paymentMethodRemoveButton));
        wait.until(ExpectedConditions.visibilityOf(getDriver().findElement(By.xpath("//button[@class='MuiButtonBase-root th-button th-add-method-button']"))));
